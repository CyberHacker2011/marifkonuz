  ...
  return (
    <>
      <header className="flex justify-between items-center p-7 shadow-md bg-white">
        ...
        {/* Navbar Links */}
        <ul
          className={`absolute md:static top-16 left-0 w-full md:w-auto md:flex space-y-4 md:space-y-0 md:space-x-4 bg-white md:bg-transparent shadow-md md:shadow-none p-4 md:p-0 transition-all duration-300 ${
